          ...
          <div className="col-lg-3 col-md-6 pb-3">
            <div className="icon-box "  >
              ...
              <div className="icon-box-content">
                ...
                <p>Amet consectetur elit loreme ipsum dolor sit and towards the good fit.</p>
              </div>
            </div>
          </div>
          <div className="col-lg-3 col-md-6 pb-3">
            <div className="icon-box " >
              ...
              <div className="icon-box-content">
                ...
                <p className='redlabel'>Rem Lopsum dolor sit amet, consectetur adipi elit folor sit amet .</p>
              </div>
            </div>
          </div>
        </div>
